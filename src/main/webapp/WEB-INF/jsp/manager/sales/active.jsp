...
<head>
    ...
    <script type="application/javascript" language="JavaScript" src="Resource/js/sales/active.js"></script>
...
<body>
    <div id="header">
        <div id="header_content">
            ...
            <a class="header_navigation" href="/boblive/sales/active">
                <span style="color: white">ACTIVE</span>
            </a>
            <a class="header_navigation" href="/boblive/sales/negative">CODE</a>
    ...
    <div id="content">
        <br>
        <div id="dFilter">
            <form action="/boblive/sales/active/" method="post">
            ...
            <table id="content_table" border="1px" cellpadding="0px" cellspacing="0px" id="tab1">
                <thead>
                    <tr id="content_table_th">
                        ...
                        <th>ACTIVE TIME</th><th>EXPIRE DATE</th>
                        <th>
