...
<head>
    ...
    <script type="application/javascript" language="JavaScript" src="Resource/js/dealer/negative.js"></script>
...
<body>
    <div id="header">
        <div id="header_content">
            ...
            <a class="header_navigation" href="/boblive/dealer/negative">
    ...
    <div id="content">
        <div>
            <a href="/boblive/dealer/gc_auth" style="display: block; float: right"><img src="Resource/img/add1.png" alt="add"></a>
        </div><br>
        <div id="dTable">
