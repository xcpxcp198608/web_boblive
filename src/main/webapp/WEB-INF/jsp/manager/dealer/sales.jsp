...
<head>
    ...
    <script type="application/javascript" language="JavaScript" src="Resource/js/dealer/sales.js"></script>
...
<body>
    ...
    <div id="header_content">
        ...
        <a class="header_navigation" href="/boblive/dealer/sales">
            ...
            <table id="content_table" border="1px" cellpadding="0px" cellspacing="0px">
                ...
                <c:forEach items="${authSalesInfoList}" var="authSalesInfo">
                   <tr class="tr1">
                       ...
                       <td align="center">
                           <a href="/boblive/dealer/active?sales=${authSalesInfo.userName}" target="_blank">
