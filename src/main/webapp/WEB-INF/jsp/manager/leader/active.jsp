...
<head>
    ...
    <script type="application/javascript" language="JavaScript" src="Resource/js/leader/active.js"></script>
...
<body>
    <div id="header">
        <div id="header_content">
            ...
            <a class="header_navigation" href="/boblive/leader/active">
    ...
    <div id="content">
        <br>
        <div id="dFilter">
            <form action="/boblive/leader/active/" method="post">
                select dealer:<select id="dealerSelect" name="dealer" class="select1">
            ...
            <table id="content_table" border="1px" cellpadding="0px" cellspacing="0px" id="tab1">
                <thead>
                    <tr id="content_table_th">
                        ...
                        <th>ACTIVE TIME</th><th>EXPIRE DATE</th><th>UPDATE</th><th>TEMP</th>
                        <th>
                ...
                <tr style="height: 24px; font-size: 12px; color: lightslategrey">
                    ...
                    <td align="center">
                        <div class="checkboxOne">
                            <c:choose>
                                <c:when test="${authorizationInfo.temporary == true}">
                                    <input type="checkbox" value="1" id="checkboxOneInput+${status.index}" class="checkbox" checked/>
                                </c:when>
                                <c:when test="${authorizationInfo.temporary == false}">
                                    <input type="checkbox" value="1" id="checkboxOneInput+${status.index}" class="checkbox"/>
                                </c:when>
                            </c:choose>
                            <label for="checkboxOneInput+${status.index}" class="label"></label>
                        </div>
                    </td>
                    <td align="center">
                        <c:choose>
